...
export const metadata: Metadata = {
  title: 'VerifAI - Real-time Information Verification',
  description: 'VerifAI is an AI-powered browser extension that detects outdated, biased, or false information in real time.',
};
