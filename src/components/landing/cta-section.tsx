...
import { Chrome, DownloadCloud } from 'lucide-react'; // Assuming Firefox icon isn't directly in lucide, using generic download
      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex justify-center items-center gap-6">
            <Link href="#chrome-store-link" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
